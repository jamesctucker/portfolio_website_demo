...
User-submitted ratings are then stored in a database, and view via an admin page.', 'public/images/FeedbackThumbnail.png', 
...
in a separate ''page'' where the user can categorize each favorited gif. All of this data is stored in a database.', 'public/images/GiphyThumbnail.png', 
